...
public class PerformanceTabFilterImpl implements DashboardFilter{
	...
	/*
	 * To implement tabs for Performance
	 */
	public void TabDisplay(int flag,BufferedWriter output){
		MyLogger.printToStdout(3,"TabDisplay Method is called");
		this.output = output;
		try{
			if(flag  == 1){
	...
	{
		MyLogger.printToStdout(3,"Check Method is called");
	...
	{
		MyLogger.printToStdout(3,"getString Method is called");
		return strinner;
	}
	...
	public boolean containsIgnoreCase( String Container, String content ) {
		MyLogger.printToStdout(3,"Contains ignorestring Method is called");
		 if(content .equals(""))
		    return true;
